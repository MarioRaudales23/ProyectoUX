...
var TabsPage = /** @class */ (function () {
    ...
    TabsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\Users\Usuario\Desktop\ProyectoUX\ProyectoUx\src\pages\tabs\tabs.html"*/'<ion-tabs tabsPlacement=\'top\' class="menu" color="mynewcolor" >\n\n  <ion-tab [root]="tab1Root" tabTitle="INICIO"  class="menu"></ion-tab>\n\n  <ion-tab [root]="tab2Root" tabTitle="CATEGORIAS" class="menu" ></ion-tab>\n\n  <ion-tab [root]="tab3Root" tabTitle="HACER DENUNCIAS" class="menu"></ion-tab>\n\n  <ion-tab [root]="tab4Root" tabTitle="MÁS INFORMACIÓN" class="menu"></ion-tab>\n\n</ion-tabs>\n\n'/*ion-inline-end:"C:\Users\Usuario\Desktop\ProyectoUX\ProyectoUx\src\pages\tabs\tabs.html"*/,
        }),
...
var AboutPage = /** @class */ (function () {
    ...
    AboutPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-about',template:/*ion-inline-start:"C:\Users\Usuario\Desktop\ProyectoUX\ProyectoUx\src\pages\about\about.html"*/'<ion-header>\n\n  <ion-row class="tit_row">\n\n    <ion-col col-9>\n\n      <ion-item no-lines>\n\n          <h1 id=\'tit\' style="text-align: center">DENUNCIAS HONDURAS</h1>\n\n      </ion-item>\n\n    </ion-col>\n\n    <ion-col col-3>\n\n      <div *ngIf="afAuth.authState | async as user; else showLogin">\n\n        <ion-title>\n\n          <ion-item class="item item-trns text-center">\n\n            <ion-avatar item-end *ngIf="afAuth.authState | async" (click)="show()">\n\n              <img src={{currentUser.photoURL}}>\n\n            </ion-avatar>\n\n          </ion-item>\n\n        </ion-title>\n\n      </div>\n\n    </ion-col>\n\n  </ion-row>\n\n\n\n\n\n\n\n  <ng-template #showLogin>\n\n    <button float-right ion-button round color="danger" (click)="login()" icon-right>\n\n      <ion-icon name="logo-googleplus"></ion-icon>\n\n      Login\n\n    </button>\n\n  </ng-template>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n    <div class="allHome">\n\n      <div class="left">\n\n        <ion-toolbar no-borde end>\n\n          <ion-segment [(ngModel)]="main">\n\n            <ion-segment-button value="Asesinatos Extranjeros">\n\n              Asesinatos Extranjeros\n\n            </ion-segment-button>\n\n            <ion-segment-button value="Brutalidad Policial">\n\n              Brutalidad Policial\n\n            </ion-segment-button>\n\n            <ion-segment-button value="Desalojos Violentos">\n\n              Desalojos Violentos\n\n            </ion-segment-button>\n\n            <ion-segment-button value="Personas Desaperecidas">\n\n              Personas Desaperecidas\n\n            </ion-segment-button>\n\n            <ion-segment-button value="Personas detenidas">\n\n              Personas detenidas\n\n            </ion-segment-button>\n\n            <ion-segment-button value="Saqueos">\n\n              Saqueos\n\n            </ion-segment-button>\n\n            <ion-segment-button value="Censura">\n\n              Censura\n\n            </ion-segment-button>\n\n            <ion-segment-button value="Tortura">\n\n              Tortura\n\n            </ion-segment-button>\n\n          </ion-segment>\n\n        </ion-toolbar>\n\n        <div [ngSwitch]="main">\n\n          <ion-item *ngSwitchCase="\'Asesinatos Extranjeros\'">\n\n            <ion-list>\n\n              <div *ngFor="let denuncia of denuncias;">\n\n                <ion-item text-wrap *ngIf="denuncia.info.categoria == \'Asesinatos\' ">\n\n                  <ion-card >\n\n                    <ion-card-header>\n\n                      <h2>\n\n                        <b>{{ denuncia.info.encabezado }} </b>\n\n                      </h2>\n\n                    </ion-card-header>\n\n                    <ion-card-content>\n\n                      <p>{{ denuncia.info.descripcion }}</p>\n\n                    </ion-card-content>\n\n                  </ion-card>\n\n                </ion-item>\n\n              </div>\n\n            </ion-list>\n\n          </ion-item>\n\n          <ion-item *ngSwitchCase="\'Brutalidad Policial\'">\n\n            <ion-list>\n\n              <div *ngFor="let denuncia of denuncias;">\n\n                <ion-item text-wrap *ngIf="denuncia.info.categoria == \'Brutalidad\' ">\n\n                  <ion-card >\n\n                    <ion-card-header>\n\n                      <h2>\n\n                        <b>{{ denuncia.info.encabezado }} </b>\n\n                      </h2>\n\n                    </ion-card-header>\n\n                    <ion-card-content>\n\n                      <p>{{ denuncia.info.descripcion }}</p>\n\n                    </ion-card-content>\n\n                  </ion-card>\n\n                </ion-item>\n\n              </div>\n\n            </ion-list>\n\n          </ion-item>\n\n          <ion-item *ngSwitchCase="\'Desalojos Violentos\'">\n\n            <ion-list>\n\n              <div *ngFor="let denuncia of denuncias;">\n\n                <ion-item text-wrap *ngIf="denuncia.info.categoria == \'Desalojos\' ">\n\n                  <ion-card >\n\n                    <ion-card-header>\n\n                      <h2>\n\n                        <b>{{ denuncia.info.encabezado }} </b>\n\n                      </h2>\n\n                    </ion-card-header>\n\n                    <ion-card-content>\n\n                      <p>{{ denuncia.info.descripcion }}</p>\n\n                    </ion-card-content>\n\n                  </ion-card>\n\n                </ion-item>\n\n              </div>\n\n            </ion-list>\n\n          </ion-item>\n\n          <ion-item *ngSwitchCase="\'Personas Desaperecidas\'">\n\n            <ion-list>\n\n              <div *ngFor="let denuncia of denuncias;">\n\n                <ion-item text-wrap *ngIf="denuncia.info.categoria == \'Desaparecidas\' ">\n\n                  <ion-card >\n\n                    <ion-card-header>\n\n                      <h2>\n\n                        <b>{{ denuncia.info.encabezado }} </b>\n\n                      </h2>\n\n                    </ion-card-header>\n\n                    <ion-card-content>\n\n                      <p>{{ denuncia.info.descripcion }}</p>\n\n                    </ion-card-content>\n\n                  </ion-card>\n\n                </ion-item>\n\n              </div>\n\n            </ion-list>\n\n          </ion-item>\n\n          <ion-item *ngSwitchCase="\'Personas detenidas\'">\n\n            <ion-list>\n\n              <div *ngFor="let denuncia of denuncias;">\n\n                <ion-item text-wrap *ngIf="denuncia.info.categoria == \'Detenidas\' ">\n\n                  <ion-card >\n\n                    <ion-card-header>\n\n                      <h2>\n\n                        <b>{{ denuncia.info.encabezado }} </b>\n\n                      </h2>\n\n                    </ion-card-header>\n\n                    <ion-card-content>\n\n                      <p>{{ denuncia.info.descripcion }}</p>\n\n                    </ion-card-content>\n\n                  </ion-card>\n\n                </ion-item>\n\n              </div>\n\n            </ion-list>\n\n          </ion-item>\n\n          <ion-item *ngSwitchCase="\'Saqueos\'">\n\n            <ion-list>\n\n              <div *ngFor="let denuncia of denuncias;">\n\n                <ion-item text-wrap *ngIf="denuncia.info.categoria == \'Saqueos\' ">\n\n                  <ion-card >\n\n                    <ion-card-header>\n\n                      <h2>\n\n                        <b>{{ denuncia.info.encabezado }} </b>\n\n                      </h2>\n\n                    </ion-card-header>\n\n                    <ion-card-content>\n\n                      <p>{{ denuncia.info.descripcion }}</p>\n\n                    </ion-card-content>\n\n                  </ion-card>\n\n                </ion-item>\n\n              </div>\n\n            </ion-list>\n\n          </ion-item>\n\n          <ion-item *ngSwitchCase="\'Censura\'">\n\n            <ion-list>\n\n              <div *ngFor="let denuncia of denuncias;">\n\n                <ion-item text-wrap *ngIf="denuncia.info.categoria == \'Censura\' ">\n\n                  <ion-card >\n\n                    <ion-card-header>\n\n                      <h2>\n\n                        <b>{{ denuncia.info.encabezado }} </b>\n\n                      </h2>\n\n                    </ion-card-header>\n\n                    <ion-card-content>\n\n                      <p>{{ denuncia.info.descripcion }}</p>\n\n                    </ion-card-content>\n\n                  </ion-card>\n\n                </ion-item>\n\n              </div>\n\n            </ion-list>\n\n          </ion-item>\n\n          <ion-item *ngSwitchCase="\'Tortura\'">\n\n            <ion-list>\n\n              <div *ngFor="let denuncia of denuncias;">\n\n                <ion-item text-wrap *ngIf="denuncia.info.categoria == \'Tortura\' ">\n\n                  <ion-card >\n\n                    <ion-card-header>\n\n                      <h2>\n\n                        <b>{{ denuncia.info.encabezado }} </b>\n\n                      </h2>\n\n                    </ion-card-header>\n\n                    <ion-card-content>\n\n                      <p>{{ denuncia.info.descripcion }}</p>\n\n                    </ion-card-content>\n\n                  </ion-card>\n\n                </ion-item>\n\n              </div>\n\n            </ion-list>\n\n          </ion-item>\n\n        </div>\n\n      </div>\n\n\n\n\n\n      <div class="right">\n\n        <div id=\'search\'>\n\n          <br>\n\n          <br>\n\n\n\n          <h2>Buscar</h2>\n\n          <ion-toolbar>\n\n            <ion-item>\n\n              <ion-searchbar (ionInput)="getItems($event)"></ion-searchbar>\n\n            </ion-item>\n\n          </ion-toolbar>\n\n        </div>\n\n        <div id=\'denunciasRecientes\'>\n\n          <br>\n\n          <br>\n\n\n\n          <h2>Denuncias Recientes</h2>\n\n          <ion-list>\n\n              <div *ngFor="let denuncia of denuncias2; let i=index">\n\n                <ion-item *ngIf="i<=5">\n\n                  {{denuncia.info.encabezado}}\n\n                </ion-item>\n\n              </div>\n\n            </ion-list>\n\n        </div>\n\n        <div>\n\n          <br>\n\n          <br>\n\n          <h2>Contacto</h2>\n\n          <p>WhatsApp: +1-504-502-7058</p>\n\n          <p>info@denunciashonduras.com</p>\n\n        </div>\n\n      </div>\n\n    </div>\n\n</ion-content>\n\n\n\n'/*ion-inline-end:"C:\Users\Usuario\Desktop\ProyectoUX\ProyectoUx\src\pages\about\about.html"*/
        }),
...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype.changeStatus = function (Categ) {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"C:\Users\Usuario\Desktop\ProyectoUX\ProyectoUx\src\pages\home\home.html"*/'<ion-header>\n\n  <ion-row class="tit_row">\n\n    <ion-col col-9.5>\n\n      <ion-item no-lines>\n\n        <h1 id=\'tit\' style="text-align: center">DENUNCIAS HONDURAS</h1>\n\n      </ion-item>\n\n    </ion-col>\n\n    <ion-col col-3>\n\n      <div *ngIf="afAuth.authState | async as user; else showLogin">\n\n        <ion-title>\n\n          <ion-item class="item item-trns text-center">\n\n            <ion-avatar item-end *ngIf="afAuth.authState | async" (click)="show()">\n\n              <img src={{currentUser.photoURL}}>\n\n            </ion-avatar>\n\n          </ion-item>\n\n        </ion-title>\n\n      </div>\n\n    </ion-col>\n\n  </ion-row>\n\n\n\n\n\n  <ng-template #showLogin>\n\n    <button float-right ion-button round color="danger" (click)="login()" icon-right>\n\n      <ion-icon name="logo-googleplus"></ion-icon>\n\n      Login\n\n    </button>\n\n  </ng-template>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n  <div class=\'allHome\'>\n\n\n\n    <div class=\'left\'>\n\n\n\n      <div id=\'intro\'>\n\n        <ion-row class="search_row">\n\n          <ion-col col-1>\n\n            <a href="https://www.youtube.com/channel/UC2LpfiOEFMo3WSlEU-ws1Dw?view_as=subscriber" target="_blank">\n\n              <button ion-fab color="danger" mini>\n\n                <ion-icon name="logo-youtube">\n\n                </ion-icon>\n\n              </button>\n\n            </a>\n\n          </ion-col>\n\n          <ion-col col-2>\n\n            <div class="buttons" item-right>\n\n              <a href="mailto:info@denunciashonduras.com">\n\n                <button ion-fab mini>\n\n                  <ion-icon name="mail"></ion-icon>\n\n                </button>\n\n              </a>\n\n            </div>\n\n          </ion-col>\n\n        </ion-row>\n\n\n\n\n\n        <p class="textoPrincipal">Denuncias Honduras es una iniciativa civil para documentar y denunciar las violaciones de derechos humanos cometidas\n\n          por los entes de seguridad del Estado hondureño después de las Elecciones Generales de 2017.\n\n        </p>\n\n        <p class="textoPrincipal">Nuestro alcance es meramente informativo. Exhortamos a quienes son víctimas de violaciones a sus derechos, a que\n\n          recurran a las instituciones gubernamentales y organizaciones de derechos humanos correspondientes a interponer\n\n          sus denuncias.</p>\n\n        <div class=\'categorias\'>\n\n          <h2 style="text-align: center"> Categorias</h2>\n\n          <button ion-button color="secondary" (click)="changeStatus(\'Asesinatos\')">ASESINATOS EXTRAJUDIACIALES</button>\n\n          <button ion-button color="secondary" (click)="changeStatus(\'Brutalidad\')">BRUTALIDAD POLICIAL</button>\n\n          <br>\n\n          <button ion-button color="secondary" (click)="changeStatus(\'Desalojos\')">DESALOJOS VIOLENTOS</button>\n\n          <button ion-button color="secondary" (click)="changeStatus(\'Desaparecidas\')">PERSONAS DESAPARECIDAS</button>\n\n          <br>\n\n          <button ion-button color="secondary" (click)="changeStatus(\'Detenidas\')">PERSONAS DETENIDAS</button>\n\n          <button ion-button color="secondary" (click)="changeStatus(\'Saqueos\')">SAQUEOS</button>\n\n          <br>\n\n          <button ion-button color="secondary" (click)="changeStatus(\'Censura\')">CENSURA</button>\n\n          <button ion-button color="secondary" (click)="changeStatus(\'Tortura\')">TORTURA</button>\n\n          <br>\n\n        </div>\n\n        <ion-list>\n\n          <div *ngFor="let denuncia of denuncias;">\n\n            <ion-item text-wrap *ngIf="denuncia.info.categoria == categoria ">\n\n              <ion-card >\n\n                <ion-card-header>\n\n                  <h2>\n\n                    <b>{{ denuncia.info.encabezado }} </b>\n\n                  </h2>\n\n                </ion-card-header>\n\n                <ion-card-content>\n\n                  <p>{{ denuncia.info.descripcion }}</p>\n\n                </ion-card-content>\n\n              </ion-card>\n\n            </ion-item>\n\n          </div>\n\n        </ion-list>\n\n      </div>\n\n    </div>\n\n    <div class="right">\n\n      <div id=\'search\'>\n\n        <br>\n\n        <br>\n\n\n\n        <h2>Buscar</h2>\n\n        <ion-toolbar>\n\n          <ion-item>\n\n            <ion-searchbar (ionInput)="getItems($event)"></ion-searchbar>\n\n          </ion-item>\n\n        </ion-toolbar>\n\n      </div>\n\n      <div id=\'denunciasRecientes\'>\n\n        <br>\n\n        <br>\n\n\n\n        <h2>Denuncias Recientes</h2>\n\n        <ion-list>\n\n          <div *ngFor="let denuncia of denuncias2; let i=index">\n\n            <ion-item *ngIf="i<=5">\n\n              {{denuncia.info.encabezado}}\n\n            </ion-item>\n\n          </div>\n\n        </ion-list>\n\n      </div>\n\n      <div>\n\n        <br>\n\n        <br>\n\n        <h2>Contacto</h2>\n\n        <p>WhatsApp: +1-504-502-7058</p>\n\n        <p>info@denunciashonduras.com</p>\n\n\n\n\n\n      </div>\n\n    </div>\n\n\n\n  </div>\n\n\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\Usuario\Desktop\ProyectoUX\ProyectoUx\src\pages\home\home.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* ActionSheetController */],
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\Users\Usuario\Desktop\ProyectoUX\ProyectoUx\src\app\app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n\n'/*ion-inline-end:"C:\Users\Usuario\Desktop\ProyectoUX\ProyectoUx\src\app\app.html"*/
        }),
